...
// Ancho de las celdas
$w = array(30, 30, 45, 30, 45); // Ajusta los anchos según sea necesario
...
function addTableHeader($pdf, $encabezado, $w)
{
	...
	// $padding = 2; // Ajusta el valor del padding según sea necesario
...
$pdf->SetFont('helvetica', '', 12); // Asegúrate de que la fuente sea normal después del encabezado
// $fill = 0;
...
foreach ($datos as $row) {
	...
	$pdf->Cell($w[3], 6, '',0, 0, 'C'); // Espacio vacío
