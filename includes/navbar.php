  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item pe-4" id="nav-item-custom">
          <a class="nav-link text-white" href="cheques.php">Cheques</a>
        </li>
        <li class="nav-item dropdown pe-4" id="nav-item-custom">
          ...
          <ul class="dropdown-menu pe-4" aria-labelledby="navbarDropdownMenuLink">
            ...
            <li><a class="dropdown-item" href="ck_circulacion.php" >Sacar de circulación</a></li>
          </ul>
        </li>
        <li class="nav-item pe-4">
          <a class="nav-link text-white" href="otras_transacciones.php">Otras Transacciones</a>
        </li>
        <li class="nav-item pe-4" id="nav-item-custom">
          <a class="nav-link text-white" href="conciliacion.php" >Conciliación</a>
        </li>
        <li class="nav-item pe-4" id="nav-item-custom">
